...
//! secret as a value, then verifying and signing.

use std::sync::Arc;

use super::{SignatureError, Verifier, WebhookSecret, WebhookSecretError};
...
mod secret {
    ...
    fn parse_builds_the_secret_new_would() {
        ...
        assert_eq!(parsed.expose(), WebhookSecret::new("super-secret").expose());
    }
